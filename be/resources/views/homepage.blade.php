...
<head>
    ...
    <title>Demo: Dashboard - Logistics | Vuexy - Bootstrap Dashboard PRO</title>
                                ...
                                <div class="card-datatable border-top">
                                    <table class="dt-route-vehicles table">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td>{{$quiz->title}}</td>
                                                <td><a href="{{route("quiz.detail",[$quiz->id])}}" class="btn btn-sm btn-primary" /> Detail</a>
                                                    <a href="{{route("quiz.start-attempt",[$quiz->id])}}" class="btn btn-sm btn-primary" /> Start Attempt</a>
                                                </td>
                                            </tr>
                                            @endforeach
                                        </tbody>
